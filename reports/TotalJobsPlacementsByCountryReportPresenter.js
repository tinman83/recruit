var baseUrl;
function TotalJobsPlacementsByCountryReportPresenter(){
      ...
      buildReportHead: function(data){
	    ...
	    buildReportBody: function(data){
            ...
            $('#report-table').DataTable( {
                        ...
                        "bLengthChange": false,
                        columns: [
                            { "data":"countryname","title" : "Consultant", "orderable": true, "className": 'desktop' },
                        ...
                        buttons: [
                           {
                              extend: 'print',
                              title: "Total Job Placements - Monthly By Country"
                            },'excel', 'pdf'
                        ],
                        "order": [[0, 'asc' ]],
