...
function JobPlacementDetailsByCountryReportPresenter(){
	...
	var publicInt={
         ...
         showReport:function(reportId,reportCountryId,reportYear,reportMonth) {
               ...
               var post_data = {
                ...
                'reportCountryId':reportCountryId
               };
	    ...
	    buildReportBody: function(data){
            ...
            $('#report-table').DataTable( {
                        ...
                        buttons: [
                           {
                              extend: 'print',
                              title: "Job Placement Details - " + $("#report-country option:selected").text() + " " + $("#report-month option:selected").text() + " " + $("#report-year").val()
                            },'excel', 'pdf'
                        ],
                        "order": [[0, 'asc' ]],
