...
function JobsPostedDetailReportPresenter(){
	    ...
	    buildReportBody: function(data){
            ...
            $('#report-table').DataTable( {
                        ...
                        columns: [
                            ...
                            { "data":"postedDate","title" : "Date Posted", "orderable": true, "className": 'all' },
                        ...
                        buttons: [
                           {
                              extend: 'print',
                              title: "Jobs Posted Details - "+ $("#report-month option:selected").text() + " " + $("#report-year").val()
                            },'excel', 'pdf'
                        ],
                        "order": [[0, 'asc' ]],
